...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot table[x=col1, y=col2, col sep=comma]{data/final/10k_1k_avg100/recycle/grav/timing_vec.csv}
      \closedcycle;
    \addplot table[x=col1, y=col2, col sep=comma]{data/final/10k_1k_avg100/recycle/grav/timing_scal.csv}
      \closedcycle;  
    \addplot table[x=col1, y=col2, col sep=comma]{data/final/10k_1k_avg100/recycle/grav/timing_hit.csv}
      \closedcycle;
